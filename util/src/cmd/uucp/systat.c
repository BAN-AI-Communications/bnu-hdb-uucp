...
/*							*/
/*	@(#) systat.c: version 25.1 created on 12/2/91 at 18:15:54	*/
/*							*/
/*	Copyright (c) 1990 by Arix Corporation		*/
/*	All Rights Reserved				*/
/*							*/
#ident	"@(#)systat.c	25.1	12/2/91 Copyright (c) 1990 by Arix Corporation"
/*							*/
...
/*	ATT:#ident	"uucp:systat.c	2.4"			*/

/* 	kd0	Let the retry time be what the user specified even if it
		is less than RETRYTIME; if it is less than 1, make it one
*/
#ident	"@(#)uucp:systat.c	25.1"
...
long retry;
{
	...
	default:	/*  increment count and set up retry time */
		...
		*/
		/*  kd0		let retry be what user specified even if it is
				less than RETRYTIME
		*/
		if (retry < 1)
			retry = 1;
