...
/*							*/
/*	@(#) uustat.c: version 25.1 created on 12/2/91 at 18:17:09	*/
/*							*/
/*	Copyright (c) 1990 by Arix Corporation		*/
/*	All Rights Reserved				*/
/*							*/
#ident	"@(#)uustat.c	25.1	12/2/91 Copyright (c) 1990 by Arix Corporation"
/*							*/
...
/*	ATT:#ident	"uucp:uustat.c	2.5"			*/

#ident	"@(#)uucp:uustat.c	25.1"
...
static char user[9];		/* to be used by uprocessC and kprocessC */
...
char *file, *dir;
{
	...
	char fullname[MAXFULLNAME], buf[BUFSIZ];
