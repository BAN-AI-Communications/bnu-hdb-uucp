...
/*							*/
/*	@(#) expfile.c: version 23.1 created on 11/15/90 at 13:33:07	*/
/*							*/
/*	Copyright (c) 1990 by Arix Corporation		*/
/*	All Rights Reserved				*/
/*							*/
#ident	"@(#)expfile.c	23.1	11/15/90 Copyright (c) 1990 by Arix Corporation"
/*							*/
...
/*	ATT:#ident	"uucp:expfile.c	2.4"			*/

#ident	"@(#)uucp:expfile.c	23.1"
...
register int	mask;
{
	...
	if ((ret = mkdir(name, 0777)) != 0) {
	    errent(Ct_CREATE, name, errno, __FILE__, __LINE__);
	    return(FAIL);
	}
